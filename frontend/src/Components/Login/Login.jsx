...
function Login() {
  ...
  return (
    <>
     ...
     <h1 style={{marginLeft:"5rem",fontSize:"2rem",fontFamily:"sans-serif",fontWeight:"bold" ,paddingTop:"1rem"}}>Expenser</h1>
          ...
          <div className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
            ...
            <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
              ...
              <div className="relative">
                ...
                <input placeholder="123@ex.com" name='email' type="text" onChange={handleInputs} className="border placeholder-gray-400 focus:outline-none
              ...
              <div className="relative">
                <p className="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600
                    absolute">Password</p>
                <input placeholder="Password"  name='password'  type="password" onChange={handleInputs} className="border placeholder-gray-400 focus:outline-none
                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                    border-gray-300 rounded-md"/>
              </div>
